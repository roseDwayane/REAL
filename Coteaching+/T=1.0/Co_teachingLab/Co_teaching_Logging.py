...
class CoTeachingLogging(object):
    """
    ...
    def __init__(self, user):
        ...
        self.h5_csv_path = './pt_csv/%s/' % (self.bone_file_name, )
    ...
    def _append_log_file(self):
        ...
        if os.path.exists(self.log_file):
            ...
            self.df_log = pd.concat([self.df_log, df_log_new], ignore_index=True, sort=False)     # 必须用返回值赋值
        else:
    ...
    def _set_last_acc(self):
        self._set_log_file_item('last_acc1', self.monitor.history['acc1'][-1])
        self._set_log_file_item('last_acc2', self.monitor.history['acc2'][-1])
